...
for (const path of localeChunks) {
  ...
  // Extension UI and vision-model settings add their own status and action
  // copy. Shell execution contract cards add verification and risk strings.
  // Keep both dictionaries within narrowly measured, explicit allowances.
