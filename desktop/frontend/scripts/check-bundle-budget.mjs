...
// The community vision-model/settings surface adds a small amount to the
// largest startup chunk while gzip remains within the upstream cap. Keep the
// raw allowance narrow and explicit rather than making image handling depend
// on an incidental byte-for-byte chunk split.
assertBudget("largest initial JavaScript chunk raw", largestInitialJSRaw, 1_010 * 1024);
